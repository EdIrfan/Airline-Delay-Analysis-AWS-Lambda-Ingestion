...
def test_lambda_handler_success(mocker, mock_s3_event, mock_context):
    ...
    # 2. Mock the requests.patch call for pipeline config update
    mock_patch = mocker.patch('src.launcher.app.requests.patch')
    mock_patch.return_value.status_code = 200
    
    # 3. Mock the requests.post call to trigger DLT update
